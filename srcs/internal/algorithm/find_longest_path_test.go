	...
	tests := []struct {
		...
		},
		{
			graphInputs: []*input.GraphInput{
				{Start: 1, End: 2, Distance: 1.0},
				{Start: 1, End: 3, Distance: 2.0},
				{Start: 2, End: 4, Distance: 2.0},
				{Start: 3, End: 5, Distance: 1.0},
				{Start: 4, End: 3, Distance: 1.0},
				{Start: 4, End: 6, Distance: 2.0},
				{Start: 5, End: 6, Distance: 3.0},
				{Start: 6, End: 2, Distance: 1.0},
			},
			expected: []graph.EdgeID{1, 3, 5, 6, 2, 4},
		},
		{
			graphInputs: []*input.GraphInput{
				{Start: 1, End: 2, Distance: 1.0},
				{Start: 1, End: 3, Distance: 3.0},
				{Start: 2, End: 3, Distance: 1.0},
				{Start: 3, End: 4, Distance: 3.0},
				{Start: 4, End: 5, Distance: 2.0},
				{Start: 5, End: 1, Distance: 1.0},
			},
			expected: []graph.EdgeID{1, 3, 4, 5, 1},
		},
		{
			graphInputs: []*input.GraphInput{
				{Start: 1, End: 2, Distance: 1.0},
				{Start: 1, End: 3, Distance: 1.5},
				{Start: 2, End: 4, Distance: 1.0},
				{Start: 3, End: 4, Distance: 2.0},
				{Start: 4, End: 5, Distance: 2.1},
				{Start: 4, End: 6, Distance: 2.0},
				{Start: 6, End: 2, Distance: 2.0},
				{Start: 2, End: 1, Distance: 0.5},
			},
			expected: []graph.EdgeID{6, 2, 1, 3, 4, 5},
		},
		{
			graphInputs: []*input.GraphInput{
				{Start: 1, End: 2, Distance: 1.0},
				{Start: 2, End: 3, Distance: 2.0},
				{Start: 3, End: 1, Distance: 1.0},
				{Start: 3, End: 4, Distance: 2.0},
				{Start: 4, End: 5, Distance: 3.0},
				{Start: 5, End: 3, Distance: 0.5},
				{Start: 5, End: 2, Distance: 0.6},
				{Start: 5, End: 4, Distance: 0.7},
			},
			expected: []graph.EdgeID{1, 2, 3, 4, 5},
		},
		{
			graphInputs: []*input.GraphInput{
				{Start: 1, End: 2, Distance: 2.0},
				{Start: 1, End: 3, Distance: 1.0},
				{Start: 2, End: 3, Distance: 2.0},
				{Start: 2, End: 5, Distance: 3.0},
				{Start: 3, End: 4, Distance: 2.0},
				{Start: 4, End: 2, Distance: 1.0},
				{Start: 4, End: 5, Distance: 2.0},
			},
			expected: []graph.EdgeID{1, 2, 3, 4, 5},
		},
		{
			graphInputs: []*input.GraphInput{
				{Start: 1, End: 2, Distance: 1.0},
				{Start: 1, End: 3, Distance: 2.0},
				{Start: 2, End: 6, Distance: 1.0},
				{Start: 3, End: 5, Distance: 1.5},
				{Start: 5, End: 6, Distance: 2.1},
				{Start: 6, End: 3, Distance: 1.5},
			},
			expected: []graph.EdgeID{1, 3, 5, 6},
		},
		{
			graphInputs: []*input.GraphInput{
				{Start: 1, End: 2, Distance: 1.0},
				{Start: 2, End: 3, Distance: 1.0},
				{Start: 3, End: 1, Distance: 1.0},
				{Start: 1, End: 4, Distance: 2.0},
				{Start: 4, End: 5, Distance: 2.0},
				{Start: 5, End: 3, Distance: 1.0},
				{Start: 5, End: 2, Distance: 1.5},
			},
			expected: []graph.EdgeID{2, 3, 1, 4, 5, 2},
		},
		{
			graphInputs: []*input.GraphInput{
				{Start: 1, End: 2, Distance: 1.0},
				...
				{Start: 2, End: 4, Distance: 1.0},
				{Start: 4, End: 5, Distance: 2.0},
				{Start: 5, End: 6, Distance: 2.0},
				{Start: 6, End: 7, Distance: 1.0},
				{Start: 7, End: 5, Distance: 1.0},
				{Start: 6, End: 8, Distance: 1.5},
				{Start: 6, End: 3, Distance: 2.0},
				{Start: 7, End: 3, Distance: 1.5},
			},
			expected: []graph.EdgeID{7, 3, 1, 2, 4, 5, 6, 8},
		},
		{
			graphInputs: []*input.GraphInput{
				{Start: 1, End: 2, Distance: 1.0},
				...
				{Start: 2, End: 4, Distance: 1.0},
				{Start: 4, End: 5, Distance: 1.0},
				{Start: 5, End: 2, Distance: 1.0},
				{Start: 5, End: 6, Distance: 1.0},
				{Start: 6, End: 7, Distance: 1.0},
				{Start: 7, End: 8, Distance: 1.0},
				{Start: 8, End: 6, Distance: 1.0},
				{Start: 7, End: 9, Distance: 1.0},
				{Start: 9, End: 10, Distance: 1.0},
				{Start: 10, End: 8, Distance: 1.0},
				{Start: 10, End: 2, Distance: 0.5},
				{Start: 3, End: 2, Distance: 0.5},
			},
			expected: []graph.EdgeID{3, 1, 2, 4, 5, 6, 7, 9, 10, 8},
		},
		{
			graphInputs: []*input.GraphInput{
				{Start: 1, End: 2, Distance: 1.0},
				...
				{Start: 4, End: 5, Distance: 1.0},
				{Start: 5, End: 6, Distance: 1.0},
				{Start: 6, End: 4, Distance: 1.0},
				{Start: 7, End: 8, Distance: 1.0},
				{Start: 8, End: 9, Distance: 1.0},
				{Start: 9, End: 7, Distance: 2.0},
				{Start: 1, End: 4, Distance: 1.0},
				{Start: 4, End: 7, Distance: 1.0},
				{Start: 7, End: 1, Distance: 1.0},
			},
			expected: []graph.EdgeID{8, 9, 7, 1, 4, 5, 6},
		},
		{
			graphInputs: []*input.GraphInput{
				{Start: 1, End: 2, Distance: 1.0},
				...
				{Start: 8, End: 9, Distance: 1.0},
				{Start: 9, End: 7, Distance: 2.0},
				{Start: 1, End: 4, Distance: -0.1},
				{Start: 4, End: 7, Distance: -0.1},
				{Start: 7, End: 1, Distance: -0.1},
			},
			expected: []graph.EdgeID{8, 9, 7, 1, 2, 3},
		},
	}
	return tests
}
