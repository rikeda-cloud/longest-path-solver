...
func TestParseGraphEdge(t *testing.T) {
	tests := []struct {
		...
		{input: " +1,+2,+3 ", expected: &Edge{Start: 1, End: 2, Distance: 3.0}},
		{input: " 1,+2,-3.1 ", expected: &Edge{Start: 1, End: 2, Distance: -3.1}},
		{input: " 1,+2,-.12 ", expected: &Edge{Start: 1, End: 2, Distance: -0.12}},
		{input: " 1,+2,-1. ", expected: &Edge{Start: 1, End: 2, Distance: -1.0}},
		{input: " 1,+2,-0.123 ", expected: &Edge{Start: 1, End: 2, Distance: -0.123}},
